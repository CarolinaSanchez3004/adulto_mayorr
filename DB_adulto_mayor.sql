...
CREATE TABLE historia_datos_adulto_mayor (
    id_historia_datos_usuario INT PRIMARY KEY,
    ...
    grupo_sisben VARCHAR(10),
    eps VARCHAR(40),
    regimen_actual VARCHAR(15),
    fecha_ingreso DATE,
    motivo_ingreso VARCHAR(30),
    consume_alcohol VARCHAR(5),
    hace_cuanto_consume_alcohol VARCHAR(20),
    fumador VARCHAR(5),
    hace_cuanto_fuma VARCHAR(20),
    consume_drogas VARCHAR(5),
...
CREATE TABLE historia_valoracion_fisica(
    ...
    ojos VARCHAR(20),
    boca VARCHAR(20),
    oidos_deficiencia VARCHAR(20),
    piel VARCHAR(20),
    uñas VARCHAR(20),
    disminucion_muscular VARCHAR(20),
    parálisis_algun_lado_del_cuerpo VARCHAR(20),
    apariencia_fisica VARCHAR(20),
...
CREATE TABLE instrumento_aspecto_social_adulto_mayor (
    ...
    hijos_que_no_viven_con_usted VARCHAR (30) nietos_que_no_viven_con_usted VARCHAR (30) familiares_no_viven_con_usted VARCHAR (30) vecinos VARCHAR (30) amigos_no_vecinos VARCHAR (30) conyuge VARCHAR (20) hijos VARCHAR (20) nietos VARCHAR (20) otros_familiares VARCHAR (20) vecinos VARCHAR (20) amigos_no_vecinos VARCHAR (20) participa_en_grupos VARCHAR(5),
